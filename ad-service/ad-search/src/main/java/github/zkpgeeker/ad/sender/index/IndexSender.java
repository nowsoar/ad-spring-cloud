package github.zkpgeeker.ad.sender.index;

import com.alibaba.fastjson.JSON;
import github.zkpgeeker.ad.dump.table.*;
import github.zkpgeeker.ad.handler.AdLevelDataHandler;
import github.zkpgeeker.ad.index.DateLevel;
...
public class IndexSender implements ISender {
    ...
    private void level2RowData(MySqlRowData rowData) {
        if (rowData.getTableName().equals(Constant.AD_PLAN_TABLE_INFO.TABLE_NAME)) {
            ...
            for (Map<String, String> fieldMap : rowData.getFieldValueMap()) {
    ...
    public void level3RowData(MySqlRowData rowData) {
